<template>
	<div class="login-box">
		<a-form class="form-box" :layout="formLayout" ref="loginRef" :form="form" @submit="handleSubmit">
			...
			<a-form-item label="" :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol">
				<a-input type="password" placeholder="请输入用户密码" autocomplete="off" v-decorator="[
					'password',
					{
						rules: [
							{
